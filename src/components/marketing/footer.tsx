      ...
      <div className="mx-auto grid max-w-6xl gap-8 px-6 py-16 md:grid-cols-[1.5fr_1fr] md:px-12">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-full border border-[#1C1917]/10 bg-white overflow-hidden">
              <Image
                src="/icon.png"
            ...
            <p className="text-xl font-semibold tracking-tight font-heading">ONDA SERENA</p>
          </div >
