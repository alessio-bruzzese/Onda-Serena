      ...
      <div className="min-h-screen pt-24">
        <div className="mx-auto max-w-4xl px-6 py-16">
          <div className="space-y-8">
            <div>
              <h1 className="text-4xl font-light text-[#1a1a1a] mb-2">Conditions Générales d&apos;Utilisation</h1>
              <p className="text-[#A8A8A8] font-body">Dernière mise à jour : {new Date().toLocaleDateString("fr-FR")}</p>
            </div>

            <div className="space-y-6 text-[#1a1a1a]/80 font-body leading-relaxed">
              <section>
                <h2 className="mb-4 text-2xl font-light text-[#1a1a1a]">1. Acceptation des conditions</h2>
              ...
              <section>
                <h2 className="mb-4 text-2xl font-light text-[#1a1a1a]">2. Description du service</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="mb-4 text-2xl font-light text-[#1a1a1a]">3. Compte utilisateur</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="mb-4 text-2xl font-light text-[#1a1a1a]">4. Réservations et paiements</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="mb-4 text-2xl font-light text-[#1a1a1a]">5. Protection des données personnelles</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="mb-4 text-2xl font-light text-[#1a1a1a]">6. Propriété intellectuelle</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="mb-4 text-2xl font-light text-[#1a1a1a]">7. Limitation de responsabilité</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="mb-4 text-2xl font-light text-[#1a1a1a]">8. Modification des conditions</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="mb-4 text-2xl font-light text-[#1a1a1a]">9. Droit applicable</h2>
                <p className="leading-relaxed">
              ...
              <section>
                <h2 className="mb-4 text-2xl font-light text-[#1a1a1a]">10. Contact</h2>
                <p className="leading-relaxed">
